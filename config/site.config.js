...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'll@lanyzhen.onmicrosoft.com',
  ...
  email: 'mailto:lanyzhen@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/blueskybees',
    },
    {
      name: 'Telegram',
